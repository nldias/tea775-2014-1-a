...
Acho que é preciso deixar explícito o resultado
\[
\left[ g \circ \phi\right]^{-1}(A) = \left[\phi^{-1}\circ g^{-1}\right](A).
\]
\textbf{(CERTO???)}
...
\mu\left( \left[\phi_{p_0}^{-1}\circ g^{-1}\right](A_0) \cup \left[\phi_{p_1}^{-1}\circ g^{-1}\right](A_1)
\cup \ldots \cup \left[\phi_{p_n}^{-1} \circ g^{-1}\right](A_n)\right) =\\
\mu\left( \left[\phi_{p_0}^{-1}\circ g^{-1}(A_0)\right] \cup \left[\phi_{p_0}^{-1}\circ \phi_{t_1}^{-1}\circ g^{-1}(A_1)\right]
\cup \ldots \cup \left[\phi_{p_0}^{-1}\circ \phi_{t_n}^{-1} \circ g^{-1}\right](A_n)\right) \\
= \mu\left( \phi_{p_0}^{-1}\left(g^{-1}(A_0)\cup g^{-1}(A_1) \cup \ldots \cup
g^{-1}(A_n)\right)\right)\\
= \mu\left( g^{-1}(A_0) \cup g^{-1}(A_1) \cup \ldots \cup g^{-1}(A_n)\right)\\
= P(X_{t_0} \in A_0, X_{t_1}\in A_1, \ldots , x_{t_n}\in A_n)\blob
\end{multline*}

\textbf{Não sei se copiei corretamente: precisamos polir.}
